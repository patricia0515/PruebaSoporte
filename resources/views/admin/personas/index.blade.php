...
@endif
    ...
    <div class="card">
        <div class="card-header">
            <a class="btn btn-secondary" href="{{route('admin.personas.create')}}">Agregar Usuario</a>
        </div>
            ...
            <div class = "card-body" > 
                <form action = "{{route ('import')}}" method = "POST" enctype = "multipart / form-data" >   
                    ...
                    <br>
                    <button class = "btn btn-success" > Importar datos de usuario </button> 
                    <a class = "btn btn-warning" href = "{{ route('export') }}"> Generar lista de Usuarios </a>  
                </form>
            </div>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$persona->email}}</td>
                    <td width="10px">
                        <a class="btn btn-primary btn-sm" href="{{route('admin.personas.edit', $persona)}}">Acualizar</a>
                    </td>
                    <td width="10px">
