<nav class="bg-gray-800" x-data="{open:false}">
          ...
          -->
            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <a href="/" class="flex-shrink-0 flex items-center">
                    <img style="width:150px; height:60px;" class="block lg:hidden h-8 w-auto" src="vendor/adminlte/dist/img/Brandcolor01-01-01.png" alt="Montechelo">
                    <img style="width:150px; height:60px;" class="hidden lg:block h-8 w-auto" src="vendor/adminlte/dist/img/Brandcolor01-01-01.png" alt="Montechelo">
                </a>
                ...
                <div class="hidden sm:block sm:ml-6">
                    <div class="flex space-x-4">
                        ...
                        <!-- <a href="{{route('area.index')}}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Áreas</a>
                        <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Usuarios</a> -->
                    </div>
                </div>
            </div>

            <!-- Vamos a verificar si el usuario se encuentra autenticado, de ser asi va a mostrar estas opciones del menu
            de igual manera se mostrara algo mas en el caso de npo estar autenticado -->
            @auth
    ...
    <!-- Por medio de la variable open podemos manejar los eventos click para esconder los menus -->
    <!--  Menu Mobil -->
